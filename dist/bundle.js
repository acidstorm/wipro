...
/***/ function(module, exports, __webpack_require__) {
	...
	var WeatherIcon = function WeatherIcon(_ref) {
		...
		return _react2.default.createElement('img', { className: 'weather_icon', src: imageSrc });
	};
	var APPID = "41506895ac03575162719df15d34ce42";
	var KELVIN = 273.15;

	var WeatherItem = function (_Object) {
		_inherits(WeatherItem, _Object);

		function WeatherItem(params) {
			_classCallCheck(this, WeatherItem);

			var _this = _possibleConstructorReturn(this, Object.getPrototypeOf(WeatherItem).call(this));

			var dateParts = params.dt_txt.split(" ");
			_this.date = dateParts[0];
			_this.time = dateParts[1];
			_this.icon = params.weather[0].icon, _this.condition = {
	...
	var App = function (_React$Component) {
		...
		_createClass(App, [{
			...
			value: function parseData(response) {
				...
				var days = [];
				var currentWeatherItem = new WeatherItem(jsonResponse.list[0]);
				var newWeatherObject = jsonResponse.list.reduce(function (accumulator, current) {
					var day = current.dt_txt.split(" ")[0];
					var weatherItem = new WeatherItem(current);
					if (accumulator[day]) {
				...
				this.setState({ weatherObject: newWeatherObject, days: days, currentWeatherItem: currentWeatherItem, currentDay: currentDay, isLoading: false });
			}
		}, {
			key: 'fetchWeather',
			value: function fetchWeather() {
				var _state = this.state;
				var currentCity = _state.currentCity;
				var currentCountry = _state.currentCountry;

				var url = 'http://api.openweathermap.org/data/2.5/forecast?q=' + currentCity + ',' + currentCountry + '&mode=json&appid=' + APPID;
			...
			key: 'setWeatherPanel',
			value: function setWeatherPanel(currentDay, currentIndex) {
				this.setState({ currentDay: currentDay, currentIndex: currentIndex });
			}
		}, {
			key: 'slideMoved',
			value: function slideMoved(e) {
				var currentIndex = parseInt(e.target.value);
			...
			value: function render() {
				...
				var currentCity = _state2.currentCity;
				var currentCountry = _state2.currentCountry;
				var weatherObject = _state2.weatherObject;
				var days = _state2.days;
				var currentDay = _state2.currentDay;
				...
				return isLoading ? _react2.default.createElement(
					...
					_react2.default.createElement(WeatherDashboard, { weather: weatherObject[currentDay][currentIndex] }),
					_react2.default.createElement(
						'div',
						{ style: { visibility: weatherObject[currentDay].length > 1 ? "visible" : "hidden" }, className: 'slider' },
						_react2.default.createElement(_range2.default, { type: 'range', min: 0, value: currentIndex, onChange: this.slideMoved.bind(this), max: weatherObject[currentDay].length - 1, step: '1' })
					),
					_react2.default.createElement(
						'div',
						{ className: 'weather_panel' },
						days.map(function (day) {
							var weatherItem = weatherObject[day][0];
							return _react2.default.createElement(WeatherPanel, { key: day, handleClick: _this3.setWeatherPanel.bind(_this3, day, 0), day: day });
						})
					),
	...
	var WeatherPanel = function (_React$Component2) {
		_inherits(WeatherPanel, _React$Component2);

		function WeatherPanel() {
			_classCallCheck(this, WeatherPanel);

			return _possibleConstructorReturn(this, Object.getPrototypeOf(WeatherPanel).call(this));
		}
		...
		_createClass(WeatherPanel, [{
			...
			value: function render() {
				...
				return _react2.default.createElement(
					'div',
					{ onClick: handleClick, className: 'weather_panel_item' },
					_react2.default.createElement(
						'p',
						{ className: 'panel_day' },
						DAYS[date.getDay()]
	...
	var WeatherDashboard = function (_React$Component3) {
		_inherits(WeatherDashboard, _React$Component3);

		function WeatherDashboard() {
			_classCallCheck(this, WeatherDashboard);

			return _possibleConstructorReturn(this, Object.getPrototypeOf(WeatherDashboard).call(this));
		}

		_createClass(WeatherDashboard, [{
			key: 'render',
			value: function render() {
				var _props$weather = this.props.weather;
				var weather = _props$weather === undefined ? {} : _props$weather;
				var _weather$condition = weather.condition;
				var condition = _weather$condition === undefined ? {} : _weather$condition;

				var date = new Date(weather.date);

				var _weather$time$split = weather.time.split(":");

				var _weather$time$split2 = _slicedToArray(_weather$time$split, 3);

				var hours = _weather$time$split2[0];
				var minutes = _weather$time$split2[1];
				var _ = _weather$time$split2[2];
				...
				return _react2.default.createElement(
					...
					_react2.default.createElement(
						...
						_react2.default.createElement(WeatherIcon, { icon: weather.icon }),
						_react2.default.createElement('br', null),
						_react2.default.createElement(
							'h3',
							{ className: 'condition dashboard_text' },
							condition.weather
						)
					),
					_react2.default.createElement(
...
/***/ function(module, exports, __webpack_require__) {
	...
	var Range = React.createClass({
	  ...
	  onRangeClick: function onRangeClick(e) {
	    this.props.onClick(e);
	    this.props.onChange(e);
	  },
	  onRangeKeyDown: function onRangeKeyDown(e) {
...
/***/ function(module, exports, __webpack_require__) {
	...
	// module
	exports.push([module.id, "[type=range] {\n  -webkit-appearance: none;\n  margin: 15px 0;\n  width: 100%; }\n  [type=range]:focus {\n    outline: none; }\n  [type=range]::-webkit-slider-runnable-track {\n    width: 100%;\n    height: 10px;\n    cursor: pointer;\n    transition: all .2s ease;\n    box-shadow: \"inset\" 2px 2px 2px rgba(0, 0, 0, 0.2), 0 0 2px rgba(13, 13, 13, 0.2);\n    background: #bbb;\n    border: 1px solid #efefef;\n    border-radius: 15px; }\n  [type=range]::-webkit-slider-thumb {\n    box-shadow: \"\" 1px 1px 1px rgba(0, 0, 0, 0.4), 0 0 1px rgba(13, 13, 13, 0.4);\n    border: 1px solid #fff;\n    height: 30px;\n    width: 30px;\n    border-radius: 50%;\n    background: #aaa;\n    cursor: pointer;\n    -webkit-appearance: none;\n    margin-top: -11px; }\n  [type=range]:focus::-webkit-slider-runnable-track {\n    background: #c8c8c8; }\n  [type=range]::-moz-range-track {\n    width: 100%;\n    height: 10px;\n    cursor: pointer;\n    transition: all .2s ease;\n    box-shadow: \"inset\" 2px 2px 2px rgba(0, 0, 0, 0.2), 0 0 2px rgba(13, 13, 13, 0.2);\n    background: #bbb;\n    border: 1px solid #efefef;\n    border-radius: 15px; }\n  [type=range]::-moz-range-thumb {\n    box-shadow: \"\" 1px 1px 1px rgba(0, 0, 0, 0.4), 0 0 1px rgba(13, 13, 13, 0.4);\n    border: 1px solid #fff;\n    height: 30px;\n    width: 30px;\n    border-radius: 50%;\n    background: #aaa;\n    cursor: pointer; }\n  [type=range]::-ms-track {\n    width: 100%;\n    height: 10px;\n    cursor: pointer;\n    transition: all .2s ease;\n    background: transparent;\n    border-color: transparent;\n    border-width: 30px 0;\n    color: transparent; }\n  [type=range]::-ms-fill-lower {\n    box-shadow: \"\" 2px 2px 2px rgba(0, 0, 0, 0.2), 0 0 2px rgba(13, 13, 13, 0.2);\n    background: #aeaeae;\n    border: 1px solid #efefef;\n    border-radius: 30px; }\n  [type=range]::-ms-fill-upper {\n    box-shadow: \"\" 2px 2px 2px rgba(0, 0, 0, 0.2), 0 0 2px rgba(13, 13, 13, 0.2);\n    background: #bbb;\n    border: 1px solid #efefef;\n    border-radius: 30px; }\n  [type=range]::-ms-thumb {\n    box-shadow: \"\" 1px 1px 1px rgba(0, 0, 0, 0.4), 0 0 1px rgba(13, 13, 13, 0.4);\n    border: 1px solid #fff;\n    height: 30px;\n    width: 30px;\n    border-radius: 50%;\n    background: #aaa;\n    cursor: pointer; }\n  [type=range]:focus::-ms-fill-lower {\n    background: #bbb; }\n  [type=range]:focus::-ms-fill-upper {\n    background: #c8c8c8; }\n\nbody {\n  font-family: Lato;\n  margin: 0; }\n\n#container {\n  display: flex;\n  height: 100vh;\n  background-color: #dfdfdf;\n  background-size: cover; }\n\n.app {\n  background-color: rgba(255, 255, 255, 0.95);\n  text-align: center;\n  color: #555;\n  margin: auto;\n  width: 67%;\n  min-width: 300px;\n  max-width: 800px;\n  box-shadow: 0 2px 5px rgba(0, 0, 0, 0.2); }\n\n.weather_panel_item {\n  display: inline-block;\n  width: 16%;\n  box-sizing: border-box;\n  border: 1px solid #e0e0e0;\n  cursor: pointer; }\n  .weather_panel_item:hover {\n    font-weight: bold;\n    background-color: #f2f2f2; }\n  .weather_panel_item .panel_day {\n    margin: 0.3em; }\n\n.weather_panel {\n  text-align: center; }\n\nimg {\n  vertical-align: middle; }\n\n.condition {\n  display: inline-block;\n  vertical-align: middle;\n  font-size: 2.4em;\n  margin: 0; }\n\n.weather_dashboard {\n  text-align: center; }\n\n.dashboard_panel {\n  vertical-align: top;\n  display: inline-block;\n  width: 47.5%;\n  margin: 0;\n  box-sizing: border-box; }\n  .dashboard_panel .dashboard_header, .dashboard_panel .dashboard_text {\n    margin: 0.2em; }\n\n.slider {\n  margin: 2em auto;\n  width: 50%; }\n", ""]);
